...
# Approach 1: Deeper Neural Network
model1 = Sequential([
...
history1 = model1.fit(X_train, y_train, epochs=300, batch_size=32, validation_data=(X_val, y_val), verbose=1)

test_loss1, test_mse1 = model1.evaluate(X_test, y_test)
print(f"Test Mean Squared Error (Approach 1 - Deeper NN): {test_mse1}")
